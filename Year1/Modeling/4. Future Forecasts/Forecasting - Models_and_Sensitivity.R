...
#Coef estimates of VMT forecast Table 5-1)
coef(lasso_best)
...
#vmt sensitivity results -- Table 5-2
...
#decomposition chart, Figure G-3
df_TMS%>% 
  pivot_longer(-Year, names_to = "type") %>% 
  ggplot(aes(Year, value, fill = type)) + geom_col() + labs(x = 'Year', y = 'Transit Share %')


#TMS Coefficents Table 5-5
TMS_coef

#TMS sensitivity Table 5-6
