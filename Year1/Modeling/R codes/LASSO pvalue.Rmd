...
summary(glmnetSE(data=VMT.dat.s, 
                 cf.no.shrnkg = c("Unemployment.Rate.1","TotalArtToFwyMiles","TransitDRM","RegisteredBEVCarsMillions","populationTelework"), 
                 alpha=1,r=500, method="none",seed = 1234, ncore = 1))

#Compare with multiple linear regression
summary(lm(VMT.dat.s[,1]~VMT.dat.s[,"Unemployment.Rate.1"]+VMT.dat.s[,"TotalArtToFwyMiles"]+VMT.dat.s[,"TransitDRM"]+VMT.dat.s[,"RegisteredBEVCarsMillions"]+VMT.dat.s[,"populationTelework"]))
