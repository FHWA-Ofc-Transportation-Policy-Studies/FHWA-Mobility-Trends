...
Year 2 County Level - all year 2 code and data for Mobility Trends project
    ...
    Data Engineering - Code and data required to create the county modeling data for year 2
    ...
    Modeling - Where we train, test, and validate our Champion models. This code includes templates to run your own version of champion models and check model performance
        ...
        EDA - Exploratory Data analysis
            EDA_Task4_Modeling_Data_12_6_23.ipynb - inspection of final modeling dataset. 
            eda_fhwa_county_types_10_18.ipynb - Inspection of FHWA County Type elements
        Modeling - Template to train, test, and measure performance of models
            ...
            champion_VMT_y2_1_8_24.rds - Champion VMT model as shown in the Task 4 Report
            champion_GHG_y2_1_8_24.rds - Champion GHG model as shown in the Task 4 Report
            champion_TMS_y2_1_10_24.rds - Champion Transit Users model as shown in the Task 4 Report
    ...
    Forecasting - Where we use our champion models within the modeling folder to predict performance metrics through 2050
